...
public class MemoryGame {
    ...
    public void drawFrame(String s) {
        ...
        StdDraw.clear();
        StdDraw.text(width / 2, height / 2, "String is:" + s);
        StdDraw.show();
        StdDraw.pause(1000);
        StdDraw.clear();
        StdDraw.text(width / 2, height, new String("Round:" + round));
        StdDraw.pause(500);
        StdDraw.show();
        StdDraw.clear();
        StdDraw.text(width/ 2, height / 2, "Please input");
        StdDraw.show();
        StdDraw.pause(1000);
    }
